...
export const MOCK_WORKERS = [
  {
    ...
    skillsList: ['Stitching', 'Alterations', 'Embroidery', 'Pattern Cutting'],
    city: 'Rajpura',
    state: 'Punjab',
    rating: 4.9,
    reviewsCount: 88,
  ...
  },
  {
    ...
    primarySkill: 'Stitching',
    skillsList: ['Stitching', 'Alterations', 'Boutique Sewing'],
    city: 'Rajpura',
    state: 'Punjab',
    rating: 4.85,
    reviewsCount: 64,
    ...
    remainingCapacity: '25 pieces/day',
    rate: '₹24 / piece',
    expectedRate: '₹24 / piece',
    availableToday: true,
    hasDisability: true,
    disabilityType: 'Locomotor / Physical Disability',
    disabilityAccommodations: ['Flexible Work Hours / Rest Breaks', 'Wheelchair Accessible Workspace'],
    workPassport: {
      totalCompletedJobs: 94,
      completedJobs: 94,
      onTimeRate: 95,
      qualityScore: 92,
      verifiedBadges: ['Consistent Delivery', 'KYC Verified', '♿ PwD Inclusive Worker']
    }
  },
  {
    id: 'wrk-2',
    ...
    primarySkill: 'Electrical Wiring',
    skillsList: ['Electrical Wiring', 'Solar Installation', 'Appliance Repair', 'Switchboard Repair'],
    city: 'Patiala',
    state: 'Punjab',
    rating: 4.95,
    reviewsCount: 142,
  ...
  },
  {
    ...
    primarySkill: 'Electrical Wiring',
    skillsList: ['Electrical Wiring', 'AC Repair', 'Appliance Repair'],
    city: 'Rajpura',
    state: 'Punjab',
    rating: 4.7,
    reviewsCount: 45,
    ...
    experienceYears: 5,
    dailyCapacity: '3 visits/day',
    remainingCapacity: '3 visits/day',
    rate: '₹500 / day',
    expectedRate: '₹500 / day',
    availableToday: true,
    hasDisability: false,
    disabilityType: '',
    disabilityAccommodations: [],
    workPassport: {
      totalCompletedJobs: 72,
      completedJobs: 72,
      onTimeRate: 93,
      qualityScore: 90,
      verifiedBadges: ['KYC Verified', 'Local Specialist']
    }
  },
  {
    id: 'wrk-5',
    name: 'Meenakshi Devi',
    profession: 'Apparel Stitching Assistant',
    primarySkill: 'Stitching',
    skillsList: ['Basic Stitching', 'Button Hemming'],
    city: 'Rajpura',
    state: 'Punjab',
    rating: 4.1,
    reviewsCount: 12,
    ...
    skills: ['Stitching'],
    experienceYears: 1,
    dailyCapacity: '8 pieces/day',
    remainingCapacity: '8 pieces/day',
    rate: '₹20 / piece',
    expectedRate: '₹20 / piece',
    availableToday: true,
    hasDisability: true,
    disabilityType: 'Hearing & Speech Impairment',
    disabilityAccommodations: ['Assistive Audio/Visual Support'],
    workPassport: {
      totalCompletedJobs: 15,
      completedJobs: 15,
      onTimeRate: 85,
      qualityScore: 82,
      verifiedBadges: ['KYC Verified']
    }
  }
];
...
export const MOCK_OPPORTUNITIES = [
  ...
  },
  {
    ...
    quota: '10 setups',
    deadlineDays: 3,
    requiredDailyCapacityPerWorker: 2,
    budgetPerUnit: '₹1,200 / setup',
    suggestedRatePerUnit: 1200,
    status: 'Open',
    accessibilitySupported: true,
    supportedAccommodations: ['Flexible Work Hours / Rest Breaks']
  },
  {
    id: 'opp-3',
    ...
    quota: '200 boxes',
    deadlineDays: 4,
    requiredDailyCapacityPerWorker: 25,
    budgetPerUnit: '₹15 / box',
    suggestedRatePerUnit: 15,
    status: 'Open',
    accessibilitySupported: true,
    supportedAccommodations: ['Home-based / Remote Work Option', 'Ergonomic Seating / Adapted Tools']
  }
];
