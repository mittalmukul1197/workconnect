  ...
  return (
    <div className="space-y-6 animate-fade-in text-slate-900">
      <div className="space-y-1">
        ...
        <p className="text-xs text-slate-500 font-medium">Scored across Skill Fit, Availability, Capacity, Proximity, Experience, Reliability & Rate.</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {MOCK_WORKERS.map((worker) => (
          <Card key={worker.id} borderVariant="indigo" className="p-6 space-y-4 bg-white shadow-sm hover:shadow-md">
