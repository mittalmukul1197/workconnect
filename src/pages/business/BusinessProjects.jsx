          ...
          return (
            <Card key={proj.id} borderVariant="indigo" className="p-6 space-y-6 bg-white shadow-md rounded-3xl">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-100 pb-4">
                <div>
                  <div className="flex items-center gap-2">
                    <h3 className="font-extrabold text-lg text-slate-900">{displayTitle}</h3>
                    <Badge variant="success">{displayStatus}</Badge>
                  </div>
              ...
              <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200/80 space-y-2 text-xs">
                <div className="flex justify-between font-bold">
                  ...
                  <span className="text-indigo-600">{proj.completedQuantity} / {proj.totalQuantity} {proj.unitLabel} {t('common.completed')} ({Math.round((proj.completedQuantity / proj.totalQuantity) * 100)}%)</span>
                </div>
